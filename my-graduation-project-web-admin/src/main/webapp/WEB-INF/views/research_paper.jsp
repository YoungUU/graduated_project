                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="row" style="padding-left: 12px; padding-top: 10px">
                                ...
                                <a href="/research/exportExcel" type="button" class="btn  btn-sm btn-default"><i class="fa fa-upload"></i>导出</a>&nbsp;
                                <%--
                                <a href="/research/uploadExcel" type="button" class="btn  btn-sm btn-default"><i class="fa fa-download"></i>导入</a>&nbsp;
--%>
                                <form action="/research/uploadExcel" enctype="multipart/form-data" method="post" style="display:inline-block">
