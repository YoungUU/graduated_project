                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools">
                                <form action="/research/searchProject" method="post">
                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach items="${projects}" var="project">
                                    <tr>
                                        ...
                                        <td>${project.mainPerson}</td>
                                        <td>${project.context}</td>
                                        <td>${project.scale}</td>
                                        <td>
                                            <a href="/research/formProject?id=${project.id}" type="button" class="btn  btn-sm btn-primary"><i class="fa fa-edit"></i>编辑</a>&nbsp;
                                            <a href="/research/deleteProject?id=${project.id}" type="button" class="btn  btn-sm btn-danger"><i class="fa  fa-trash-o"></i>删除</a>&nbsp;
                                        </td>
                                    </tr>
                                </c:forEach>
